...
Forks should replace Xintinglei-specific branding with their own. The attribution required by [ADDITIONAL_TERMS.md](ADDITIONAL_TERMS.md) may use the name `Xintinglei Website` solely to identify the origin of the software.
